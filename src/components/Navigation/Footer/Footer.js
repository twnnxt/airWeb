...
const Footer = () => (
    <>
                ...
                <Row>
                    <Col xs="12" className="mt-3 mt-md-0">
                        <Row className="d-flex justify-content-start">
                            <Col xs="auto"><h5 style={{ fontSize: "14px", fontWeight: "bold" }}><a href="#" className="text-dark">關於我們</a></h5></Col>
                            ...
                            <Col xs="auto"><h5 style={{ fontSize: "14px", fontWeight: "bold" }}><a target="_blank" href="https://google.com" className="text-dark">開源專案</a></h5></Col>
                    ...
                    <Col xs="12" className="mt-4">
                        <Row>
                            <Col md="4" xl="3">
                                <strong className="text-danger" style={{ fontSize: "150%" }}>02-1234-5678</strong>
                                <br />
                            ...
                            <Col md="8" xl="9" className="mt-3 mt-md-0">
                                <p>有任何問題？</p>
                                <a href="mailto:hi@5xruby.tw" className="text-dark">test123@gmail.tw</a>
                                <br />
                                <p>地址： <a target="_blank" href="https://goo.gl/lz5v93" className="text-dark">10046 台北市一區二路3號四樓</a></p>
                            </Col>
                        </Row>
                    </Col>
                </Row>
        ...
        <div className="mt-5 text-center">
            <p>© 2000 - 2020 喳喳黑寶股份有限公司 (blacks CO., LTD)</p>
            <p>請給我最新文案 第 0000 號</p>
        </div>
    </>
);
